        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#F8F9FA]/80 text-sm">
              <li><Link href="/services/ayurveda" className="hover:text-white transition-colors">Ayurveda in JVC</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#F8F9FA]/80 text-sm">
              <li><Link href="#" className="hover:text-white transition-colors">Panchakarma in Dubai</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Abhyanga Massage</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Shirodhara</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Sports Injury Rehab</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">PRP Hair</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">IV Drip at Home</Link></li>
            </ul>
          </div>
