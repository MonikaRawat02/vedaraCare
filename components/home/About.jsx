          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-8 py-8 border-t border-white/10 max-w-[580px]">
              <div className="space-y-2">
                <h4 className="text-[32px] font-serif font-semmibold text-[#C9A961]">5,000+</h4>
                <p className="text-[14px] opacity-80 font-sans leading-tight">Patients Treated</p>
              </div>
              <div className="space-y-2">
                <h4 className="text-[32px] font-serif font-bold text-[#C9A961]">15+</h4>
                <p className="text-[14px] opacity-80 font-sans leading-tight">DHA-Licensed Practitioners</p>
              </div>
              <div className="space-y-2">
                <h4 className="text-[32px] font-serif font-semibold text-[#C9A961]">20+</h4>
                <p className="text-[14px] opacity-80 font-sans leading-tight">Treatment Protocols</p>
              </div>
            </div>
          </div>
