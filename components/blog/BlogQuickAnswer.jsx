  ...
  return (
    <div className="bg-[#F5F2ED] py-20 px-6">
      <div className="max-w-[880px] mx-auto">
        ...
        <h2 className="text-center text-[28px] md:text-[36px] font-serif font-medium text-[#1A1A1A] mb-10 leading-tight">
          {title}
        </h2>
        <div className="border-l-[3px] border-[#D4A373] pl-8 md:pl-12">
          <p className="text-[18px] md:text-[20px] leading-[1.6] text-[#4A4A4A] font-sans">
            {content}
          </p>
        </div>
      </div>
